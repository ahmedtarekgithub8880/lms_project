                    ...
                    <form role="form" class="form-edit-add"
                        ...
                        <div class="panel-body" id="dynamicTable">
                            ...
                            @if ($edit)
                                ...
                                @livewire('group' , ['dataTypeContent' => $dataTypeContent])
                            ...
                            @if ($add)
                                <div class="form-group  col-md-4 ">
                                    ...
                                    <select class="form-control" name="addmore[0][group_day]" tabindex="-1"
                                        aria-hidden="true">
                                ...
                                <div class="form-group  col-md-4 ">
                                    ...
                                    <input type="time" class="form-control" name="addmore[0][group_time]"
                                        placeholder="choose time" value="">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <button type="button" name="add" id="add" class="btn btn-success"> <i
                                            class="voyager-plus"></i> Add More</button>
                                </div>
...
<script type="text/javascript">
    ...
    $("#add").click(function() {
        ++i;
        $("#dynamicTable").append(`<div id="row"><div class="form-group  col-md-4 ">
                                <label class="control-label" for="group_day">Day</label>
                                <select class="form-control" name="addmore['+i+'][group_day]" tabindex="-1" aria-hidden="true">
                                    <option selected disabled>Choose day</option>
                                    <option value="0">Saturday</option>
                                    <option value="1">Sunday</option>
                                    <option value="2">Monday</option>
                                ...
                                <div class="form-group  col-md-4 ">
                                    <label class="control-label" for="group_time">Time</label>
                                    <input type="time" class="form-control" name="addmore['+i+'][group_time]" placeholder="choose time" value="">
                                </div>
                            <div class="form-group col-md-4" >
                                <br>
