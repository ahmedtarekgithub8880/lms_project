        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    <div>
                        <table id="tb" style="width: 35% ; margin: 12px">
                            <thead>
                                <tr class="head">
                                    <td>Day</td>
                                    <td>Time</td>
                            ...
                            <tbody>
                                @php $groupTimes = \App\GroupTime::where('group_id' ,$dataTypeContent->id)->get();  @endphp
                                @forelse($groupTimes as $g)
                                    <tr>
                                        <td>{{ $g->getDay() }} </td>
                                        <td> {{ $g->group_time->format('h:i')  }}</td>
